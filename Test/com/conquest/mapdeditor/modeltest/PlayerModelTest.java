...
public class PlayerModelTest {
	...
	/**
	 * Method used to check whether the player is having the corresponding country or not.
	 */
	@Test
	...
	/**
	 * Basic test conducted to check whether all the methods are functioning properly or not.
	 */
	@Test
